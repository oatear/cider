...
@Component({
  selector: 'app-default-card-block',
  templateUrl: './default-card-block.component.html',
  styleUrls: ['./default-card-block.component.scss']
})
export class DefaultCardBlockComponent {
